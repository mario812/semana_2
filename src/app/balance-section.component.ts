...
@Component({
  selector: 'reto-bc-balance-section',
  imports: [MatTableModule, MatCard],
  standalone: true,
  template: `
    <mat-card class="w-[400px] px-4 py-8">
      <h2 class="text-center text-3xl mb-4" style="color: white;">Balance</h2>

      @if (!account()) {
        <p class="text-center" style="color: white;">Conecta tu wallet para ver tu balance.</p>
      } @else {
