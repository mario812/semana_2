...
@Component({
  selector: 'reto-bc-transactions-section',
  imports: [MatTableModule, MatCard],
  standalone: true,
  template: `
    <mat-card class="w-[500px] px-4 py-8">
      <h2 class="text-center text-3xl mb-4" style="color: white;">Historial de Transacciones</h2>

      @if (!transactions()) {
        <p class="text-center" style="color: white;">Conecta tu wallet para ver las transacciones.</p>
